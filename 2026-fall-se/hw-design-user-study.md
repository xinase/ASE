...
## 0. 复杂度自评
上周很多团队和个人都匆忙写了项目的 NABCD，在进一步细化之前，我们可以对照《构建之法》第四版第 8 章关于复杂度的分类，分析自己的项目复杂度。

- 简单：	需求明确、技术成熟、边界清晰、可预测，简单：做出来就知道对不对，比如一个固定功能的传感器模块，或者重复一个市面上主流智能硬件的基本功能。  
...
自评之后，团队必须回答三个问题：
- 如果本项目属于“复杂”或“混乱”，你们打算如何收敛问题边界？（例如：限定场景、限定用户、限定功能集）
