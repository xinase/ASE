...
**- NeXT Computer / NeXTcube (1988–1990)** 在商业硬件上遭遇了滑铁卢。乔布斯坚持整机必须是外形绝对完美的 1 英尺镁合金立方体，拐角必须严控在 90 度，为此耗费巨资定制模具，并强推昂贵且读取缓慢的磁光驱。高达六千到一万美元的定价注定了它的市场惨败；不过其沉淀下的 NeXTSTEP 软件生态极为丰厚，不仅孕育了蒂姆·伯纳斯-李的第一个万维网系统，日后更成为苹果 macOS 和 iOS 的技术底座。
...
所谓“乔布斯的直觉 -- 我懂，用户不懂，我来告诉用户什么是好的”，从来不是不败的神话。他真正的厉害之处，不在于他没有犯错，而在于他经历了数次的项目崩溃与流放后，终于学会了将自己对用户体验的严苛品味，与工业界顶级的供应链管理（如库克）以及工程可行性（如软硬件团队的底线测试）结合在一起，才最终有了后来 iPod、iPhone 的顺利发展与商业爆发。

我们当中很多人同时具备乔布斯的各种属性，最坏的组合可能是（坏脾气，过度自信）， 那就需要各种角色和流程来保证自己不犯大错误。  
