...
**- Macintosh (1984)** 最终走向了商业上的高开低走。它以革命性的图形界面和鼠标惊艳了世界，但乔布斯固执地将内存卡死在 128KB 且不允许扩展，同时再度拒绝内置风扇，导致机器发热严重且极易出现内存耗尽的死机。短暂的热潮退去后销量断崖式下滑，这场工程妥协与市场的失利直接导致他在 1985 年被逐出苹果。

**- NeXT Computer / NeXTcube (1988–1990)** 在商业硬件上遭遇了滑铁卢。乔布斯坚持整机必须是外形绝对完美的 1 英尺镁合金立方体，拐角必须严控在 90 度，为此耗费巨资定制模具，并强推昂贵且读取缓慢的磁光驱。高达六千到一万美元的定价注定了它的市场惨败；不过其沉淀下的 NeXTSTEP 超前软件设计，在十年后成为苹果 macOS 和 iOS 的技术底座。
...
我们当中很多人同时具备乔布斯的各种属性，说不定某些方面远超乔布斯，盖茨，马斯克加起来, 当然也可能有最坏的组合（坏脾气，过度自信），工程组织之所以要立规矩、设门禁、搞需求分析与协同机制，不是为了限制真正的创造力，恰恰是为了防止这种自以为是造物主的个人英雄把团队搞翻车。如果真有乔布斯的水准，先用市场和用户检验过的硬核成果证明自己；在那之前，先把契约写清，把测试跑通，按工程流程办事。  
