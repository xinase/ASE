...
下面，我们逐个视角分析：每个视角下，学生练的是什么；这些训练，在“有 AI 工具在手”时，是应该被替代、被增强，还是被坚守。
...
- 有 AI 工具在手时一样吗：恰恰相反。有 AI 在手时，学生最容易陷入的陷阱是“以为自己懂了” —— 因为 AI 能快速给出看起来正确的答案，学生会产生“我也会了”的幻觉。当堂测试的价值，恰恰在于让学生在无外部工具辅助下验证自己的理解。

> 李同学反馈很直接：“当堂测试提供即时反馈，比‘回去自己觉得懂了’更可靠。”

有了 AI，我们还要测试一些知识点么？是的。测试并不是不能考记忆 —— 人类学习任何东西，都不可能把所有关键点都交给 AI 去查，自己脑子里空空如也。一定量的记忆是必要的：基本概念、核心原则、常见模式的名字和适用场景，这些东西记不住，你连“该问 AI 什么”都抓瞎。 很多核心常识（如传感器的物理限制、供电基础），如果到了现场还要问 AI，你的硬件早就烧坏了。
...
在航天与心理学领域，有一个著名的现象叫“总观效应”（Overview Effect，或俯瞰效应）。当宇航员在太空亲眼目睹地球是一颗悬浮在浩瀚虚空中、没有国界线且无比脆弱的蓝色星球时，会经历深刻的认知转变：狭隘的地缘偏见被打破，全人类的共同体意识随之觉醒。回归地面后，许多宇航员的世界观会发生改变，将使命感投射到推动世界和平、环境保护以及全人类长远福祉等更宏大的议题上。

这种从宏观俯瞰的视角，正是我们希望同学们在课程中建立的格局。**我们学习软件工程、AI 技术，以及探索桌面智能硬件的创新，并不仅仅是为了在期末交付一个小产品。** 我们真正的目标，是掌握让软件与 AI 深入千行百业的底层能力，去推动“AI + X”的进步。这里的“X”提供了广阔的探索空间——涵盖人类健康、可持续能源与环境、公正的社会，甚至星际旅行。

**1. 认知的跃迁：AI 时代的工程红利**

要实现这个愿景，必须直面当前的行业变化。今天，当 AI 可以快速生成海量代码、PPT 和设计图时，大家在问：这是软件工程的终点，还是前所未有的红利？

如果把软件工程狭隘地定义为“敲键盘把明确的需求翻译成代码”，那它确实走到了终点；但如果软件工程的本质是“在不确定性中定义问题、驾驭复杂度并对不可逆的后果负责”，那么人类迎来了更大的机会。

AI 可以替代大约 90% 的常规代码编写工作，但它能将我们剩下那 10% 的核心能力大幅放大。因此，在 AI 时代，软件工程师必须完成向“总工程师（Architect / Builder）”的跃迁。

参见：https://mp.weixin.qq.com/s/sqiZPG_3r3te4KPEhtiTLw  

**2. 培养那 10% 的核心能力**

关键在于：如何主动培养那 10% 的独特能力，让 AI 真正成为放大器？这在教学中具体表现为三个支点：

* **驾驭工程（Harness Engineering）：** 核心从“亲手构造”转向“设计约束”。AI 生成代码的速度极快，工程师的竞争力在于能否通过测试阵列、契约与红蓝对抗，为其设定清晰的边界和约束。
* **工程审美与质量操守（Taste & Integrity）：** 在海量自动生成的代码中鉴别卓越。通过精读经典系统与开源代码评审，建立对极简架构、正交解耦的直观认识，坚守安全性与工程伦理的底线，避免制造技术债。
* **穿透真实需求（Empathy & Problem Framing）：** 避免“做出没人要的完美系统”的技术盲目性。AI 无法共情人类的实际困境，唯有直面真实用户的客观反馈（如 NPS 现场测评），工程师才能精准定义真问题与商业价值。

**3. 小项目的大演练场：用物理实践沉淀认知**

这正是本学期“智能硬件+软件”小项目存在的理由。要解决“AI + X”的复杂问题，必须先在具体的物理环境中实践。教育需要保留一定的“慢”，来沉淀核心能力，这与工具的“快”形成互补。

工具的迭代以天计，代码的生成以秒计，但那 10% 核心能力的习得需要时间投入且伴随试错。人类认知结构的重塑无法通过几句提示词（Prompt）快速完成。这个硬件项目场景，对我们进行了四次客观的测试：

* **接口定义受到物理约束：** 纯软件项目中，接口定义错了改代码即可。但在硬件项目中，接口定错可能意味着电路板重新设计、传感器重新选型、结构件重新开模。
* **知识传承叠加物理属性：** 交接的内容不仅是代码文档，还包括硬件调试经验、传感器标定参数、供电方案选择理由以及结构件的公差处理。
* **用户反馈在物理设备上更具体：** 用户的反馈既包含直观的感官体验（“放在桌上好看吗”“摸起来手感如何”“灯太亮吗”），也涵盖本能层（Visceral）、行为层（Behavioral）与反思层（Reflective）的交互评价。
* **商业价值受到供应链和成本制约：** BOM 成本、模具费用、量产良率、供应链周期，这些在纯代码中容易被忽略的因素，都成为商业可行性的关键变量。

项目虽小，但它让纯软件项目中容易被暂时忽略的问题变得不可回避。AI 可以辅助写代码，但无法独立完成硬件制造、成本控制和供应链打通。**物理世界的不可逆转特性，是对软件工程判断力的直接检验。**

**4. 结语：代码可以生成，但认知不能**

太空回望的启示在于：**没有一种算法能直接感知美丑，没有一种模型能完全共情人类的困境，也没有一种工具能替你对系统的崩溃承担责任。**

这正是现代软件工程教育重构的逻辑。在一个追求即时反馈的时代，我们主动开辟这片允许试错的演练场，把探索的时间投入到那 10% 的核心能力上：

* **系统思考**，需要在多次架构重构与反复排障的实践中内化；
* **需求洞察**，需要在面对真实用户的客观评价中积累；
* **职业操守**，需要在处理数据丢失或系统故障的深刻教训中建立。

我们不必害怕“慢”。AI 越强，“怎么做”的成本越低，“做什么”和“为什么做”的判断就越有价值。AI 不能替你在演示失败后重写核心模块，也不能替你完成从“以为简单”到“理解复杂”的认知跃迁。

**代码可以生成，但认知不能。体验不能。使命不能。**

经历了这些实践的学生，也许未来会忘记某项具体的语法技能，但会记住这种在真实工程挑战中解决问题的过程。我们期待，经过这学期大大小小的实践，同学们不仅能掌握技术，更能孕育出自己的“总观效应”，带着跨越代码局限的俯瞰视角与同理心，真正走向“AI + X”的星辰大海。


## 既然你看到了这里

仰望星空后，终究要低头看路。不积跬步，无以至千里。下面是几年前的千帆竞发图的一个例子，有些同学因为不按时交作业，获得负分，他们的学习小帆船沉到了水平面下。学习是一个困难而充满挑战的过程，并不是“每次都签到”就能学到东西。在 AI 时代，很多人忧心忡忡，担心 AI 抢夺了人类的工作， 我们还要仔细看清：是 AI 淘汰了某些同学，还是他们自己放任自流淘汰了自己？
