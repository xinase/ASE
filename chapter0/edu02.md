...
![FCES 论坛](A359F114-3524-4A76-BC8E-AD827ABCC562_1_105_c.jpeg)
...
**逻辑链的完整性。** 用 AI 得到的是“结果”，看不到自己思维链条上的断裂点——因为 AI 替你补了。手写时，代码不工作，你一行行推演：这个条件覆盖所有情况吗？边界条件对吗？在这个推演中，你看到的是自己思维的盲区。这叫“裸奔训练”——没有外部工具辅助时，认知边界无处可藏。
...
**判断力的来源。** 史蒂夫·乔布斯的品味并非凭空而来。他年轻时在Atari做硬件组装，看不惯粗糙的焊接，主动提出改进建议 —— 第一层判断力，是从亲手摸过电路板、见过焊点脱落长什么样开始的。但判断力不是一旦获得就能终身受用的。Apple II大获成功后，乔布斯在Lisa项目中纵容商业创意凌驾于工程原理之上，导致Lisa成为一款商业灾难。这次惨败让他明白：判断力需要不断被现实校正，昨天的成功不能保证今天的决策正确。创意必须扎根于可实现的工程基础，这段摸爬滚打赋予了他对Mac产品极致的艺术坚持 —— 他能为一个看不见的内部电路板的布局和焊点美观与人争论数周，因为他的 “手感” 告诉他，只有内在的秩序和美感才能带来外界体验的浑然天成。

但更有意思的是，当他成为皮克斯公司的 CEO 后，他在电影创意会上主动说：“我不是专家，你们可以忽略我的话。” 在消费者电子科技领域，他的判断力无人能及；在电影创意领域，他没有亲手做过、没有踩过坑，他选择了退让。即便是乔布斯，**判断力也有严格的边界，这个边界由 “你在这个领域深耕过吗” 划定。**
...
这句老话揭示了一个被 AI 时代遗忘的真理：**底层劳动的艰苦体验本身具有不可替代的认知价值，而工具的便捷使用是另一重独立的认知跃迁。两回“暖”，缺一不可。**

Uncle Bob 现在享受的是第二回“暖”——他燃烧的是 AI 生成的代码。但他在四十年的职业生涯中，早已完成了第一回“暖”——他亲手劈过足够多的柴，知道什么样的木头好烧、什么样的火候安全、什么样的约束能拦住坏代码。他设计约束系统时调用的，正是那四十年劈柴积累的“手感”。
...
课程早期让学生用 AI 快速做出原型——“先看到海”。但之后不能停在海边。手写、调试、重构、裸奔——是“游到对岸”的必要过程。没有火花（看到海），学生不知“为什么要练手写”；没有炉火（持续训练），火花熄灭后只剩灰烬。

“看到海”的另一层意义：**尽早尝到海水的苦涩。** 让学生把 demo 扔给真实用户，让他们亲耳听到“这个东西根本用不了”。用户的一句批评，比老师的任何说教都更有力。**人从痛苦和失败中学习，不是从一帆风顺中学习。**

那用 AI 重写贪吃蛇呢？贪吃蛇逻辑清晰、方案汗牛充栋，AI 一分钟生成完美代码。学生得到的是“能跑的贪吃蛇”，和一份“我会用 AI”的幻觉。**这是开胃菜，不是大学课程该花时间的地方。** 大学应该把学生扔进 AI 还搞不定的真实泥潭。
...
**学生 A**：亲手写了 10 个经典游戏，亲手调试、重构，让用户测试并改进。

**学生 B**：用 AI 重写了同样的 10 个游戏，只负责提需求和转述反馈。

公司会招募谁？

公司需要的不是“能跑通贪吃蛇”的人，而是“当游戏在用户手机上闪退、在服务器高负载下崩溃时，能徒手定位问题根源”的人。A 踩过所有的坑，建立了对渲染循环、碰撞检测、性能瓶颈的“手感”。B 只积累了“向 AI 描述需求”的经验——这项技能任何人都能在一个下午学会。

如果老板对 A 说：“学一下 AI 工具提高效率。”A 需要多久？一个下午。他已有的判断力会告诉他：AI 生成的代码哪里不对、哪里不能信。AI 只是更快的手，脑子已经有了。

如果老板对 B 说：“学一下手动 debug 底层问题。”B 需要多久？几年，或永远学不会。Debug 底层问题需要的是“手感”——在汇编层面追查崩溃、在调用栈深处发现竞态条件——只能亲手做、亲手错、亲手改来生长。

**差距不是“知识差”，是“体质差”。知识可快速补齐，体质只能慢慢练。**

如果一个学生只想成为“用 AI 快速做 demo 的人”，他不需要读 CS 专业——去读商科、设计、任何他赋能的领域，把 AI 当工具。**CS 专业的独特价值，是培养“当 AI 生成的系统要承载百万用户、要在深夜崩溃时能徒手修复”的人。**


### 十、收束

Uncle Bob 可以转型为“约束架构师”——用测试、质量门禁、CICD 来包围 AI，让代码成为易耗品，而定义“什么是正确”的约束逻辑成为核心资产。但他能设计约束，是因为他深知什么是“好”的代码、什么是“坏”的代码、什么约束能拦住“坏”的而放过“好”的。**这个“深知”，来自四十年亲手劈柴的积累。**

对初学者来说，**程序 = 算法 + 数据结构** 需要亲手写、亲手错、亲手改来内化；**软件 = 程序 + 软件工程** 中的测试、CICD、约束设计，同样需要先理解“为什么要这样约束”才能设计出有效的约束。没有底层“手感”的人，设计出来的约束系统，就像没有劈过柴的人设计的壁炉——看着像，烧起来会塌。
...
**教育的艺术，不是消除所有摩擦，而是在正确位置设计正确摩擦。** 让学生与本质困难搏斗，帮他们绕过琐碎障碍，把认知能量用在真正值得的地方。

当学生走出课堂，他们带走的不是“用过 AI”的经历，而是“没有 AI 时也能独立判断”的底气。这底气，才是所有训练的终点。


*下一篇预告：当“培养 CS 专家”成为共识，当“设计必要摩擦”成为方法，大学本身如何定位？第三篇《大学的回归——从“职业培训班”到“决策者培养”》，回答一个更根本的问题：大学的价值在哪里？*