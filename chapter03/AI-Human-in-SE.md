...
1947 年，哈佛 Mark II 计算机的继电器里夹了一只飞蛾，Grace Hopper 把它粘在日志本上，写下了“First actual case of bug being found”。这是人类第一次在计算机里捉到真实的虫子，也是“Bug”这个词进入软件工程的起点。
...
这是一场人类与自己一手打造的 AI 之间漫长而深刻的博弈。在过去几十年里，我们目睹了人类在曾经引以为傲的领地里接连退守：从西洋跳棋、国际象棋，到被誉为“人类智慧最后堡垒”的围棋；从困扰生物学半个世纪的 AlphaFold，到几秒跑通测试的 AI 编程助手……“比 AI 强”的标签被一个接一个地剥离。
...
但作为软件工程师，读到后面总觉得哪里不对。这篇文章把我们日常面对的“软件维护”、“生态演化”、“团队协作”这些事，说得太轻巧了。

原文作者后来又给出了几轮典型的反驳——这些反驳很常见，在技术讨论中几乎必然出现。我把它整理成三个层次，逐一回应。
